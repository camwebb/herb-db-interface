...
<table border="0">
    <tr>
        <td align="right" width="10"><label class="label"><b>Specimen Id </b></label>:</td>
	<td width="260">
            <label><?php echo $ID_Specimen; ?></label>

	</td>
        <td width="250" rowspan="4">Test data specimen</td>
	...
	<td>
            <input name="Collector_Field_Number"  size="" type="text" maxlength="" <?php echo $readonly;?> value="<?php echo $Collector_Field_Number;?>" />
	</td>
    </tr>
    <tr>
        <td align="right"><label class="label">Collector Names :</label></td>
	<td>
            <input name="Collector_Name" class="textbox" type="text" maxlength="" <?php echo $readonly;?> value="<?php echo $Collector_Name;?>"  />
	</td>
    </tr>
    <tr>
	...
	<td width="">
            ...
            to
            <input name="Coll_Date_To" type="text" maxlength="10" size="8" <?php echo $readonly;?> value="<?php echo $Coll_Date_To;?>" />
	</td>
