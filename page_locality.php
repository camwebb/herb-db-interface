...
<fieldset style="padding: 0px 0px 0px 0px; margin-bottom: 5px">
					...
					<table border="0">
						<tr>
							...
							<td width="150" align="right" >Latitude From </td>
							<td width="200">
						...
						<tr>
							...
							<td>
							<input type="text" name="Country_Name" size="8" <?php echo $readonly;?> value="<?php echo $Country_Name;?>" />Sub District<input type="text" name="Sub_District_Name" size="10" <?php echo $readonly;?> value="<?php echo $Sub_District_Name;?>" />
						...
						<tr>
							...
							<td>
									...
									Island
									<input class="textbox" type="text" name="Island_Name" size="10" <?php echo $readonly;?> value="<?php echo $Island_Name?>"/>
