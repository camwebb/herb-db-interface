    ...
    ?>
        ...
        <hr>
            ...
            <table border="0">
				...
				<td align="center" class="menu" id="<?php if ($page == 'map') echo 'selected' ?>"><a href="?page=map<?php echo $pid; ?>" style="text-decoration:none; color:#000;"><img src="img/icon/map.png"/>&nbsp;Map</a></td>
        ...
        <div id="footer" align="center">
                <label><?php echo $app['conf']['powered_by']; ?></label>
        </div>
